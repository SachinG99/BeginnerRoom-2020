...
#Calculator which can find area of certan shapes and do some formulas
#Shapes Include:
#Square, Cube, Rectangle, Rectangular Prism
#Triangle, Triangular Prism, Pythagorem Therom
#Circle and Sphere
...
UserShape = raw_input("Choose A Shape To Be Measured (Find The Area): Square, Cube, Rectangle, Rectangular Prism, Triangle, Triangular Prism, Pythagorean Theorem, Circle, Sphere:     ")
...
if UserShape == "Pythagorean Theorem":
    ...
    Therom = raw_input("Choose The Side To Figure Out: A or B or C: ")
    print(" ")
    if Therom == "C":
